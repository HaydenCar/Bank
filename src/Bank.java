...
public class Bank extends Frame implements ActionListener {
    ...
    private Bank(Builder builder) {
        ...
        this.rightNow = builder.rightNow;
    }
    ...
    public static class Builder {
        ...
        public Builder setTimeZone(TimeZone timeZone) {
            this.rightNow = Calendar.getInstance(timeZone);
            return this;
        }
    ...
    public void showMainMenu() {
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(transfer));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(createAccount));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(deleteAccount));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(deposit));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(withDraw));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(showAcc));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(showAllAcc));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(delUser));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(logOut));
        ...
        // Uses decorator
        mainPanel.add(new ButtonDecorator(quit));
    ...
    public void showLoginMenu() {
        ...
        // Command for Sign up and Login
        signUp = new JButton("Sign Up");
        signUp.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                executeCommand(new SignUp(Bank.this));
            }
        });
        ...
        signIn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                executeCommand(new Login(Bank.this, tfName.getText(), tfPass.getText()));
            }
        });
        mainPanel.add(signIn);
        // End of Command here

        timeLabel = new JLabel("This is running using the timezone from: " + rightNow.getTimeZone().getID());
    ...
    public static void main(String args[]) {
        Bank b1 = BankBuilderDirector.getDefaultBank();
        b1.showLoginMenu();
    }
    ...
    // executeCommand method from brightspace
    private void executeCommand(Command command){
        // We could keep a command history in a stack here
        command.Execute();
    }

    // Getters and setters for using private vars
    public HashMap<User, ArrayList<Account>> getUsers() {
        return users;
    }
